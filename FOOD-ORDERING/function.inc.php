...
function send_email($email,$html,$subject){
	...
	$mail->SMTPSecure="tls";
	$mail->SMTPAuth=true;
	$mail->Username="mangeshkokare55555@gmail.com";
	// $mail->Password="Food_Ordering@test";
	$mail->Password="wqlaceedgmkqznoa"; //use password of google App passwords
	$mail->setFrom("mangeshkokare55555@gmail.com");
